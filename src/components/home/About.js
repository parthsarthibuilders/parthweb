            ...
            <div className="container max-w-[90%] mx-auto">
                <div className="grid lg:grid-cols-5 grid-cols-1 lg:gap-10 gap-4">
                    ...
                    <div className="col-span-3">
                        ...
                        <p className="mb-3 font-medium">-Experience luxury living with <span className=" text-[#DAB221] font-semibold underline">Parth Sarthi Buildestate Pvt. ltd.</span> </p>
