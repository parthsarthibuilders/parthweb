            ...
            <div className="container max-w-[90%] mx-auto">
                <div className="grid lg:grid-cols-5 grid-cols-1 lg:gap-10 gap-4">
                    ...
                    <div className="col-span-3">
                        ...
                        <p className="mb-3 font-medium">-Experience luxury living with <span className=" text-[#DAB221] font-semibold underline">Parth Sarthi build estate private limited</span> </p>
                        ...
                        <p className="my-3 font-medium">-Why Choose <span className=" text-[#DAB221] font-semibold underline">Parth Sarthi build estate private limited</span> ? </p>

                        <p className="mb-2 text-sm font-light"><span className=" text-[#DAB221] font-semibold underline">Parth Sarthi build estate private limited</span> stand out from the competition for several reasons. Firstly, their commitment to quality and customer satisfaction is unmatched. Each project is carefully planned and executed to ensure that residents experience the highest level of comfort and luxury. Secondly, their attention to detail is evident in every aspect of their properties, from modern architectural designs to state-of-the-art amenities. Lastly, their premium amenities and prime locations make it convenient for residents to access essential services and enjoy a vibrant lifestyle.</p>
                        <p className="mb-2 text-sm font-light"><span className=" text-[#DAB221] font-semibold underline">Parth Sarthi build estate private limited</span> is a trustworthy brand in the real estate industry with a proven track record of delivering high-quality residential projects in Jaipur.</p>
